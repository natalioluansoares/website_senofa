        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('materia/update/'.$materia->id_materia)?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="kode_materia" value="<?= $materia->kode_materia?>"
                            class="form-control phone-number <?=isset($errors['kode_materia']) ? 'is-invalid' : null ?>" 
                        ...
                        <div class="input-group">
                            ...
                            class="form-control phone-number <?=isset($errors['materia']) ? 'is-invalid' : null ?>" 
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="horas_materia" value="<?= $materia->horas_materia?>" 
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['loron_materia']) ? 'is-invalid' : null ?>">
                                <option value="<?= $materia->loron_materia ?>"><?= $materia->loron_materia ?></option>
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="dia_materia" value="<?= $materia->dia_materia ?>" 
                            ...
                            <div class="input-group">
                                ...
                                <?= isset($errors['aula_materia']) ? 'is-invalid': null?>">
                                    ...
                                    <option value="<?= $value->id_aula ?>" 
                                        <?= $value->id_aula == $value->id_aula ? 'selected' : null ?>><?= $value->aula ?>
                                    </option>
                                        <?php  endforeach;  ?>
                                </select>
                                <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?= isset($errors['professores']) ? 'is-invalid': null?>">
                                ...
                                <option value="<?= $value->id_user?>" 
                                    <?= $materia->professores == $value->id_user ? 'selected' : null ?>><?= $value->naran_kompleto ?>
                                </option>
                                    <?php  endforeach;  ?>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <a href="<?= base_url('materia/'.$materia->professores);?>" class="btn btn-info mb-3"><i class="fas fa-sharp fa-regular fa-backward"></i></a>
                        </div>
                    </div>
                    </form>
                </div>
