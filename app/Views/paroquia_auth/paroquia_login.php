      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-5 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <p class="text-muted">Akun Ne'e So Padre Paroquia MaK Bele Uja..Se Mak Laos Parteinsia Husi Padre Paroquia
               Labele Atu Tama Ka Uja...Obrigado<span class="text-warning">...FIAT VOLUNTAS TUA...</span></p>
            ...
            <?php endif; ?>
            <form method="POST" action="<?= site_url('paroquiaprocess')?>" class="needs-validation" novalidate="">
              <?= csrf_field(); ?>
            <div class="form-group">
                <label for="email">Naran Kompleto</label>
                <input id="text" type="text" class="form-control" name="naran_kompleto_paroquia" tabindex="1" required autofocus>
                <div class="invalid-feedback">
                  Naran Se Mamuk, Favor Bele Hatama Ita Nia Naran
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="invalid-feedback">
                  Senha Se Mamuk, Favor Bele Hatama Ita Nia Senha
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="custom-control custom-checkbox">
                  ...
                  <label class="custom-control-label" for="remember-me">Hatudu Senha</label>
                </div>
              </div>
