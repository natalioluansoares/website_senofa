    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                    <form action="<?= base_url('propinas')?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                      <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?= isset($errors['naran_alunos']) ? 'is-invalid': null?>">
                                    ...
                                    <option value="<?= $value->id_alunos ?>" 
                                        <?= old('naran_alunos') == $value->id_alunos ? 'selected' : null ?>><?= $value->naran_kompleto_alunos ?>
                                    </option>
                                        <?php  endforeach;  ?>
                                </select>
                            ...
                            <div class="input-group">
                                ...
                                <?= isset($errors['aula_alunos']) ? 'is-invalid': null?>">
                                    ...
                                    <option value="<?= $value->id_aula ?>" 
                                        <?= old('aula_alunos') == $value->id_aula ? 'selected' : null ?>><?= $value->aula ?>
                                    </option>
                                        <?php  endforeach;  ?>
                                </select>
                                <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="propinas" value="<?= old('propinas')?>" 
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="loron_propinas" value="<?= old('loron_propinas')?>" 
                        ...
                        <?php
                            ...
                            $myTime = new Time('now', 'Asia/dili', 'en_US');
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="horas_propinas" value="<?= date('H:i:s'); ?>" 
                            class="form-control phone-number <?=isset($errors['horas_propinas']) ? 'is-invalid' : null ?>" 
                            placeholder="Horas Selu" id="jam" readonly>
                            <div class="invalid-feedback">
                        ...
                        <a href="<?= base_url('propinas');?>" class="btn btn-info mb-3"><i class="fas fa-sharp fa-regular fa-backward"></i></a>
                        </div>
                    </div>
                    </form>
                </div>
