        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('familia/update/'.$familia->id_instituisaun)?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                      <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="naran_kompleto" value="<?= $familia->naran_kompleto ?>" 
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['jenero']) ? 'is-invalid' : null ?>">
                                <option value="<?= $familia->jenero; ?>"><?= $familia->jenero; ?></option>
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['status']) ? 'is-invalid' : null ?>">
                                <option value="<?= $familia->status; ?>"><?= $familia->status; ?></option>
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['status_servisu']) ? 'is-invalid' : null ?>">
                                <option value="<?= $familia->status_servisu; ?>"><?= $familia->status_servisu; ?></option>
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="loron_moris" value="<?= $familia->loron_moris; ?>" 
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="fatin_moris" value="<?= $familia->fatin_moris; ?>" 
                        ...
                        <a href="<?= base_url('familia');?>" class="btn btn-info mb-3"><i class="fas fa-sharp fa-regular fa-backward"></i></a>
                        </div>
                    </div>
                    </form>
                </div>
