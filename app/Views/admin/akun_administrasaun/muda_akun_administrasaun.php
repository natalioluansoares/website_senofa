        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('akunadministrasaun/update/'. $akunadministrasaun->id_user)?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?= isset($errors['id_role']) ? 'is-invalid': null?>">
                                <option value="<?= $akunadministrasaun->naran_kompleto ?>"><?= $akunadministrasaun->naran_kompleto ?></option>
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['jenero']) ? 'is-invalid' : null ?>">
                                <option value="<?= $akunadministrasaun->jenero ?>"><?= $akunadministrasaun->jenero ?></option>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="numero_telemovel" value="<?= $akunadministrasaun->numero_telemovel ?>" 
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['status']) ? 'is-invalid' : null ?>">
                                <option value="<?= $akunadministrasaun->status ?>"><?= $akunadministrasaun->status ?></option>
                                <option value="Solteiro" <?= old('status') ==  $akunadministrasaun->status ? 'selected' : null ?>>Solteiro</option>
                                <option value="Solteira" <?= old('status') ==  $akunadministrasaun->status ? 'selected' : null ?>>Solteira</option>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['status_servisu']) ? 'is-invalid' : null ?>">
                                <option value="<?= $akunadministrasaun->status_servisu ?>"><?= $akunadministrasaun->status_servisu ?></option>
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="loron_moris" value="<?= $akunadministrasaun->loron_moris ?>" 
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="fatin_moris" value="<?= $akunadministrasaun->fatin_moris ?>" 
