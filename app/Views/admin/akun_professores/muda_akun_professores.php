        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('akunprofessores/'. $akunprofessores->id_user)?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                     <input type="hidden" name="_method" value="PATCH">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?= isset($errors['id_role']) ? 'is-invalid': null?>">
                                <option value="<?= $akunprofessores->naran_kompleto ?>"><?= $akunprofessores->naran_kompleto ?></option>
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['jenero']) ? 'is-invalid' : null ?>">
                                <option value="<?= $akunprofessores->jenero ?>"><?= $akunprofessores->jenero ?></option>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="numero_telemovel" value="<?= $akunprofessores->numero_telemovel ?>" 
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['status']) ? 'is-invalid' : null ?>">
                                <option value="<?= $akunprofessores->status ?>"><?= $akunprofessores->status ?></option>
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['status_servisu']) ? 'is-invalid' : null ?>">
                                <option value="<?= $akunprofessores->status_servisu ?>"><?= $akunprofessores->status_servisu ?></option>
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="loron_moris" value="<?= $akunprofessores->loron_moris ?>" 
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="fatin_moris" value="<?= $akunprofessores->fatin_moris ?>" 
                        ...
                        <a href="<?= base_url('akunprofessores');?>" class="btn btn-info mb-3"><i class="fas fa-sharp fa-regular fa-backward"></i></a>
                        </div>
                    </div>
                    </form>
                </div>
