    ...
    <div class="section-body">
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="<?= site_url('akunequipaformador/new');?>" class="btn btn-primary mb-3"><i class="fas fa-solid fa-plus"></i></a>
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <td><a href="<?= site_url('akunequipaformador/'.$e->id_user.'/edit') ?>" class="btn btn-success"><i class="fas fa-user-edit"></i></a></td>
                        <form action="<?= site_url('akunequipaformador/'.$e->id_user)?>" method="post" autocomplete="off" 
