    ...
    <div class="section-body">
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="<?= site_url('professores/new');?>" class="btn btn-primary mb-3"><i class="fas fa-solid fa-plus"></i></a>
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <td><?= $e->loron_moris?></td>
                        <td><?= $e->role?></td>
                        <td><a href="<?= site_url('professores/edit/'.$e->id_instituisaun) ?>" class="btn btn-success"><i class="fas fa-user-edit"></i></a></td>
                        <form action="<?= site_url('professores/delete/'.$e->id_instituisaun)?>" method="post" autocomplete="off" 
