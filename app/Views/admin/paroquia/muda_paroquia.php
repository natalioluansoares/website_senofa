        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('paroquia/update/'.$paroquia->id_instituisaun)?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                      <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="naran_kompleto" value="<?= $paroquia->naran_kompleto ?>" 
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['jenero']) ? 'is-invalid' : null ?>">
                                <option value="<?= $paroquia->jenero; ?>"><?= $paroquia->jenero; ?></option>
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['status']) ? 'is-invalid' : null ?>">
                                <option value="<?= $paroquia->status; ?>"><?= $paroquia->status; ?></option>
                                ...
                                <option value="paroquia" <?= old('status') == 'paroquia' ? 'selected' : null ?>>paroquia</option>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['status_servisu']) ? 'is-invalid' : null ?>">
                                <option value="<?= $paroquia->status_servisu; ?>"><?= $paroquia->status_servisu; ?></option>
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="loron_moris" value="<?= $paroquia->loron_moris; ?>" 
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="fatin_moris" value="<?= $paroquia->fatin_moris; ?>" 
                        ...
                        <a href="<?= base_url('paroquia');?>" class="btn btn-info mb-3"><i class="fas fa-sharp fa-regular fa-backward"></i></a>
                        </div>
                    </div>
                    </form>
                </div>
