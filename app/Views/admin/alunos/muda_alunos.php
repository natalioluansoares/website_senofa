        ...
        <div class="row">
            <div class="col-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('alunos/update/'.$alunos->id_instituisaun)?>" method="post" autocomplete="off">
                     <?= csrf_field(); ?>
                      <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="naran_kompleto" value="<?= $alunos->naran_kompleto ?>" 
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['jenero']) ? 'is-invalid' : null ?>">
                                <option value="<?= $alunos->jenero; ?>"><?= $alunos->jenero; ?></option>
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['status']) ? 'is-invalid' : null ?>">
                                ...
                                <option value="alunos" <?= old('status') == 'alunos' ? 'selected' : null ?>>alunos</option>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <?=isset($errors['status_servisu']) ? 'is-invalid' : null ?>">
                                <option value="<?= $alunos->status_servisu; ?>"><?= $alunos->status_servisu; ?></option>
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="loron_moris" value="<?= $alunos->loron_moris; ?>" 
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="fatin_moris" value="<?= $alunos->fatin_moris; ?>" 
                        ...
                        <a href="<?= base_url('alunos');?>" class="btn btn-info mb-3"><i class="fas fa-sharp fa-regular fa-backward"></i></a>
                        </div>
                    </div>
                    </form>
                </div>
