        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h4><i class="fas fa-eye mr-2" style="font-size: large;"></i><?= $show;?> 
                    <i class="fas fa-eye mr-2" style="font-size: large;"></i></h4>
                </div>
                    ...
                    <div class="col-lg-9">
                        <div class="dropdown">
                            <button class="btn btn-dark dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Materia Estudante <?= $tinanhorario ?>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-dark" style="width: 60%;">
                                <?php foreach( $kode as $k): ?>
                                <li><a class="dropdown-item" href="<?= base_url('horarioprofessores/'.$k->kode_materia.'/edit')?>">
