...
<body>
  <div id="app">
    <div class="main-wrapper">
      <div class="navbar-bg" style="background-color: gold;"></div>
      <nav class="navbar navbar-expand-lg main-navbar">
        <form class="form-inline mr-auto">
          ...
          <div class="search-element">
            ...
            <h6 style="color: black;"><strong>SEMINARIO NOSSA SENHORA DE FATIMA BALIDE DILI</strong></h6>
        ...
        <ul class="navbar-nav navbar-right">
          ...
          class="nav-link nav-link-lg message-toggle beep"><i class="far fa-envelope" style="color: black;"></i></a>
          ...
          <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" 
          class="nav-link notification-toggle nav-link-lg beep"><i class="far fa-bell" style="color: black;"></i></a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
              ...
              <div class="dropdown-list-content dropdown-list-icons">
                ...
                <a href="#" class="dropdown-item">
                  <div class="dropdown-item-icon bg-danger text-white">
                    <i class="fas fa-exclamation-t  riangle"></i>
                  </div>
                  <div class="dropdown-item-desc">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" style="color: black;" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="<?= base_url()?>/template/assets/img/avatar/avatar-1.png" class="rounded-circle mr-1">
            <div class="d-sm-none d-lg-inline-block" style="color: black;">Hi, <?= userLogin()->naran_kompleto ?></div></a>
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="<?= base_url('administratorlogout') ?>" class="dropdown-item has-icon text-danger">
                <i class="fas fa-sign-out-alt"></i> Logout
              </a>
              <?php endif; ?>
              <?php if (session()->id_role == 2) : ?>
              <a href="<?= base_url('equipaformadorlogout') ?>" class="dropdown-item has-icon text-danger">
                <i class="fas fa-sign-out-alt"></i> Logout
              </a>
              <?php endif; ?>
              <?php if (session()->id_role == 3) : ?>
              <a href="<?= base_url('professoreslogout') ?>" class="dropdown-item has-icon text-danger">
                <i class="fas fa-sign-out-alt"></i> Logout
              </a>
              <?php endif; ?>
              <?php if (session()->id_role == 6) : ?>
              <a href="<?= base_url('administrasaunlogout') ?>" class="dropdown-item has-icon text-danger">
                <i class="fas fa-sign-out-alt"></i> Logout
              </a>
              <?php endif; ?>
            </div>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?= base_url('/')?>">seminario nossa senhora</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?= base_url('/')?>">SENOFA</a>
          </div>
