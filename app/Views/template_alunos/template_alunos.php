                            ...
                            <div class="container-fluid">
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="<?= base_url('horarioalunos')?>">Foti Horario Estudante</a></li>
                                        <li><a class="dropdown-item" href="<?= base_url('horarioaula')?>">Horario Aula</a></li>
                                        <li><a class="dropdown-item" href="<?= base_url('horarioalunos/new')?>">Valore Estudante</a></li>
                                        <li><a class="dropdown-item" href="#">Muda Senha</a></li>
                                        <li><a class="dropdown-item" href="<?= base_url('propinasalunos')?>">Osan Propinas</a></li>
