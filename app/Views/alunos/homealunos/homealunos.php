                    ...
                    <table class="table" >
                        <tbody>
                            <tr>
                                ...
                                <td><h6>:<?= userLoginAlunos()->naran_kompleto_alunos ?></h6></td>
                            </tr>
                            <tr>
                                <td style="background-color: gold;"><strong>Tinan Tama</strong></td>
                                <td><h6>:<?= userLoginAlunos()->tinan_tama ?></h6></td>
                            </tr>
                            <tr>
                                <td style="background-color: gold;"><strong>Status</strong></td>
                                <td><h6>:<?= userLoginAlunos()->status_alunos ?></h6></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td><h6>:<?= userLoginAlunos()->role ?></h6></td>
                            </tr>
                            <tr>
                                <td style="background-color: gold;"><strong>Hili</strong></td>
                                <td><h6>: <a href="<?= base_url('alunoslogout') ?>" class="btn" style="background-color: cornflowerblue;"><i class="fas fa-sign-out-alt"></i></a></h6></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
