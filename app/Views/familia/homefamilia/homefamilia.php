                    ...
                    <table class="table" >
                        <tbody>
                            <tr>
                                ...
                                <td><h6>:<?= userLoginFamilia()->naran_kompleto_familia ?></h6></td>
                            </tr>
                            
                            <tr>
                                <td style="background-color: gold;"><strong>Status</strong></td>
                                <td><h6>:<?= userLoginFamilia()->status_familia ?></h6></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><h6>:<?= userLoginFamilia()->role ?></h6></td>
                            </tr>
                            <tr>
                                <td style="background-color: gold;"><strong>Hili</strong></td>
                                <td><h6>: <a href="<?= base_url('familialogout') ?>" class="btn" style="background-color: cornflowerblue;"><i class="fas fa-sign-out-alt"></i></a></h6></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
