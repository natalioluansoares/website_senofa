      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-5 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <p class="text-muted">Akun Ne'e So Familia Ne'ebe Nia Oan Eskola Iha Senofa MaK Bele Uja...Obrigado<span class="text-warning">...FIAT VOLUNTAS TUA...</span></p>
            ...
            <?php endif; ?>
            <form method="POST" action="<?= site_url('familiaprocess')?>" class="needs-validation" novalidate="">
              <?= csrf_field(); ?>
            <div class="form-group">
                <label for="email">Naran Kompleto</label>
                <input id="text" type="text" class="form-control" name="naran_kompleto_familia" tabindex="1" required autofocus>
