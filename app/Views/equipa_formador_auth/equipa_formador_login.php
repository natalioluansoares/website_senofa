      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-5 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <p class="text-muted">Akun Ne'e So Equipa Formador Senofa MaK Bele Uja..
              Se Mak La Parteinsia Iha Equipa Formador Senofa Labele Atu Tama Ka Uja...
            ...
            <?php endif; ?>
            <form method="POST" action="<?= site_url('equipaformadorprocess')?>" class="needs-validation" novalidate="">
              <?= csrf_field(); ?>
