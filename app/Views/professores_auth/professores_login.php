      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-5 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <p class="text-muted">Akun Ne'e So Professores Husi Senofa MaK Bele Uja..Se Mak La Parteinsia Husi Professores
               Senofa Labele Atu Tama Ka Uja...Obrigado<span class="text-warning">...FIAT VOLUNTAS TUA...</span></p>
            ...
            <?php endif; ?>
            <form method="POST" action="<?= site_url('professoresprocess')?>" class="needs-validation" novalidate="">
              <?= csrf_field(); ?>
