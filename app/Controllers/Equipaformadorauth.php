...
class Equipaformadorauth extends BaseController
{
    ...
    public function login()
    {
        ...
        return view('equipa_formador_auth/equipa_formador_login');
    }
    ...
    public function logoutequipa()
    {
        session()->destroy('id_user');
        return redirect()->to(site_url('equipaformadorauth'));
